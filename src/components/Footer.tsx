            ...
            <div className="pt-2">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-9 h-9 rounded-xl bg-slate-800/80 border border-slate-700/60 text-slate-400 hover:text-white hover:bg-[#0A66C2] hover:border-[#0A66C2] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center shadow-2xs group"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-800/80 border border-slate-700/60 text-slate-400 hover:text-white hover:bg-black hover:border-slate-700 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center shadow-2xs group"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-800/80 border border-slate-700/60 text-slate-400 hover:text-white hover:bg-[#5865F2] hover:border-[#5865F2] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center shadow-2xs group"
                >
                  <svg className="w-4 h-4 fill-currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-800/80 border border-slate-700/60 text-slate-400 hover:text-white hover:bg-[#25D366] hover:border-[#25D366] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center shadow-2xs group"
                >
                  <svg className="w-4 h-4 fill-currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                  className="w-9 h-9 rounded-xl bg-slate-800/80 border border-slate-700/60 text-slate-400 hover:text-white hover:bg-[#24292e] hover:border-slate-600 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center shadow-2xs group"
                >
                  <svg className="w-4 h-4 fill-currentColor" viewBox="0 0 24 24">
