...
const terms = [
  ...
  "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Peenya Small Industries, Karnataka.",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16 scroll-reveal">
          ...
          <p className="text-sm text-muted-foreground">
            Last updated on <time dateTime="2026-04-08">08-04-2026 08:42:11</time>
          </p>
        </div>

        <div className="max-w-3xl space-y-10 scroll-reveal scroll-reveal-delay-1">
          {/* Intro */}
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a
              binding agreement by and between <strong className="text-foreground">SHIVANNA SRI HARSHA</strong>{" "}
              ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of
            ...
            <p>
              ...
              Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and
              without assigning any reason. It is your responsibility to periodically review these Terms to stay
              informed of updates.
            </p>
            <p>
          ...
          <ol className="space-y-5">
            {terms.map((term, index) => (
              <li key={index} className="flex gap-4">
                <span className="flex-shrink-0 mt-0.5 w-7 h-7 rounded-full bg-accent/10 text-accent text-xs font-bold flex items-center justify-center">
                  {index + 1}
                </span>
          ...
          <div className="pt-6 border-t border-border">
            <p className="text-sm text-muted-foreground">
              ...
              <a href="/contact-us" className="text-accent hover:underline">
                contact us
              </a>
              .
            </p>
